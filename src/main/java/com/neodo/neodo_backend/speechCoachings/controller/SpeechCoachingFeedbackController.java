...
public class SpeechCoachingFeedbackController {
    ...
    public ResponseEntity<CommonResponse<SpeechCoaching>> speechCoachingChangeText(@PathVariable("speech_coaching_id") Long speechCoachingId, @Valid @RequestBody SpeechCoachingChangeTextRequest request){
