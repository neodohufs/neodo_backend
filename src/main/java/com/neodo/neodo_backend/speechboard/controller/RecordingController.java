...
public class RecordingController {
    ...
    public ResponseEntity<CommonResponse<Object>> uploadRecording(
        ...
        RecordingModel recording = recordingService.saveRecording(file, userId, title, atmosphere, purpose, scale, audience, limitTime);
